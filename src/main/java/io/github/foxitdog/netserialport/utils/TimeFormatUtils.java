...
public enum TimeFormatUtils {
	...
	/** 日期时间格式 <code>[yyMMddHHmmss]</code> */
	DATE_TIME_COMPACT_YY("yyMMddHHmmss"),
	...
	/** 日期时间格式 <code>[yyyyMMddHHmmss0SSS]</code> */
	DATE_TIME_0MILLI_COMPACT("yyyyMMddHHmmss0SSS"),

	/** 日期时间格式 <code>[yyyyMMddHHmmss.SSS]</code> */
	DATE_TIME_DotMILLI_COMPACT("yyyyMMddHHmmss.SSS"),

	/** 日期时间格式 <code>[yyyyMMddHHmmss.SSS]</code> */
	DATE_TIME_DotMILLI_TRANSVERSE("yyyy-MM-dd HH:mm:ss.SSS"),

	/** 日期时间格式 <code>[ddMMyyHHmmss.SSS]</code> */
	DATE_TIME_RMC_COMPACT("ddMMyyHHmmss.SSS"),
	...
	public String format(Date date) {
		LocalDateTime ldt = LocalDateTime.ofInstant(date.toInstant(), ZoneId.of("+8"));
	...
	public String transFormat(String date,String newFormat){
		LocalDateTime localDateTime = parse2LDT(date);
